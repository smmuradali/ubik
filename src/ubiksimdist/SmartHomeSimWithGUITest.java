 ...
 */
public class SmartHomeSimWithGUITest extends UbikSimWithUI {

    protected static SmartHomeSim simExample;
    //public TestPerson p;
    //Murad: protected static int demoCode = 3;
    //protected static int demoCode = 2; //1 for escape in MapExample, 2 for pathfinding in primeraPlantaUMU_DIIC, 3 for UbikSim 1.0 example

//    public static void setDemoCode(int demoCode) {
//        SmartHomeSimWithGUI.demoCode = demoCode;
//    }

    public SmartHomeSimWithGUITest(Ubik ubik) {
        super(ubik);
    }
...
//            ph.addPersons(5, true, ph.getPersons().get(0));
            //change their name
            //ph.changeNameOfAgents("TestPerson");
//        }
    ...
    public static void main(String[] args) {
        ...
        simExample = new SmartHomeSim();
        simExample.setPathScenario("./environments/draft3.ubiksim");
...
//            case 2:
//                //Murad: 
//                //simExample.setPathScenario("./environments/primeraPlantaUM.ubiksim");
//                simExample.setPathScenario("./environments/draft2.ubiksim");
//                break;
//                
//            case 3:
...
//        
        ...
        SmartHomeSimWithGUITest vid = new SmartHomeSimWithGUITest(simExample);
